...
<tr><td>{|Ansprechpartner|}:</td><td><input type="text" size="36" value="[NAME2]" name="name2"></td></tr>
<tr><td>{|Zusatz|}:</td><td><input type="text" size="36" value="[NAME3]" name="name3"></td></tr>
...
[GEWICHT]
<tr><td>{|Sofort abschlie&szlig;en|}:</td><td><input type="checkbox" value="1" name="sofortabschliessen" [SOFORTABSCHLIESSEN] /></td></tr>
