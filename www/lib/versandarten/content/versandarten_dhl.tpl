	...
	<tr>
		<td align="center">
			...
			<form action="" method="post">
				[ERROR]
				<h1>Label-Drucker Internetmarke <font color=red>[ZUSATZ]</font></h1>
				<br>
				<b>Empf&auml;nger</b>
				<br>
				<br>
					...
					<tr>
						<td>
							...
							<table style="float:left;">
								...
								<tr>
									<td>PLZ/Ort:</td>
									<td><input type="text" name="plz" size="5" value="[PLZ]">&nbsp;<input type="text" size="30" name="ort"
																																												value="[ORT]"></td>
								</tr>
								<tr>
									<td>Strasse/Hausnummer:</td>
									<td><input type="text" size="30" value="[STRASSE]" name="strasse">&nbsp;<input type="text" size="5"
																																																 name="hausnummer"
																																																 value="[HAUSNUMMER]">
									</td>
								</tr>
								...
								<tr>
									<td>Leitcodierung aktiviert:</td>
									<td><input type="checkbox" name="coding" [DHL_CODING_CHECKED] value="1"></td>
								</tr>
							</table>
