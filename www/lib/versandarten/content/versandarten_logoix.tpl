...
<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr><td>Inhaltsbeschreibung:</td><td><input type="text" name="inhalt" id="inhalt" size="36" value="Warensendung"></td></tr>
<tr><td>Frachtart:</td><td><select id="paketart" name="paketart" style="width: 23em">
  <option value="1">Paket</option>
  <option value="2">Sperrgut</option>
  <option value="3">Europalette</option>
  <option value="4">Einwegpalette</option>
</select></td></tr>
<tr><td>Empfänger:</td><td><select id="empfaenger" name="empfaenger" style="width: 23em">
  <option value="2">Privatperson</option>
  <option value="1">Unternehmen</option>
</select></td></tr>
<tr><td>Zerbrechlich:</td><td><input type="checkbox" name="glass" id="glass"></td></tr>
</table>
