...
class LogViewer
{
    ...
    public const MODULE_NAME = 'LogViewer';
    ...
    public $javascript = [
        './classes/Modules/LogViewer/www/js/delete_logs.js',
    ];
    ...
    {
        $this->LogMenu();
        $this->app->YUI->TableSearch('TAB1', 'log_viewer', 'show', '', '', basename(__FILE__), __CLASS__);
    ...
    public function LogMenu(): void
    {
        ...
        $this->app->erp->MenuEintrag('index.php?module=logviewer&action=list', 'Zur&uuml;ck zur &Uuml;bersicht');
        $this->app->erp->MenuEintrag('index.php?module=logviewer&action=list', '&Uuml;bersicht');
        $this->app->erp->MenuEintrag('index.php?module=logviewer&action=settings', 'Einstellungen');
    }
    ...
    {
        $this->app->erp->RemoveFile('www/pages/log.php');
