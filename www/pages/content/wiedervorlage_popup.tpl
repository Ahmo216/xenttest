...
<script src="js/lib/jquery.timeline.js?v=3"></script>


<script>
    window.employeeAutocomplete = '[AUTOCOMPLETEMITARBEITER]';
	...
	function EditWiedervorlage(id,refresh=false) {
        ...
        if (isNaN(data.id) || data.id === 0) {
          $('#editWiedervorlage').find('#editlabelrow').hide();
				...
				App.loading.close();
        ResubmissionPopupUi.linkProject();
        ResubmissionPopupUi.linkSubProject();
				[AFTERPOPUPOPEN]
                ...
                <div class="inside inside-full-height">
                    ...
                    <fieldset>
                        ...
                        <table class="mkTableFormular">
                            ...
                            <tr>
                                <td width="">{|Projekt|}:</td>
                                <td colspan="3"><input type="text" name="editprojekt" id="editprojekt" size="75" />
                                    <a href="#" id="project_link" target="_blank">
                                        <img alt="{|Projekt|}"
                                             src="themes/new/images/forward.svg"
                                             border="0" />
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="3"><input type="text" name="editsubproject" id="editsubproject" size="75" />
                                    <a href="#" id="subproject_link" target="_blank">
                                        <img alt="{|Teilprojekt|}"
                                             src="themes/new/images/forward.svg"
                                             border="0" />
                                    </a>
                ...
                <div class="inside inside-full-height">
                    ...
                    <fieldset>
                        ...
                        <table class="mkTableFormular">
                            ...
                            <tr>
                                <td><label for="resubmissiontask-customer">{|Kontakt / Adresse|}:</label></td>
