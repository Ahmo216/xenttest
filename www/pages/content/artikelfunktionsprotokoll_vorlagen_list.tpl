...
$(document).ready(function() {
    ...
    buttons: {
      ...
      SPEICHERN: function() {
        ArtikelFunktionsprotokollVorlagenEditSave();
      }
    }
  });
...
function ArtikelFunktionsprotokollVorlagenEditSave() {

    $.ajax({
        url: 'index.php?module=artikelfunktionsprotokoll_vorlagen&action=save',
        data: {
...
function ArtikelFunktionsprotokollVorlagenEdit(id) {

    $.ajax({
        url: 'index.php?module=artikelfunktionsprotokoll_vorlagen&action=edit&cmd=get',
        data: {
            id: id
        },
        method: 'post',
...
function updateLiveTable(i) {
    var oTableL = $('#artikelfunktionsprotokoll_vorlagen_list').dataTable();
    oTableL.fnFilter('%');
    oTableL.fnFilter('');   
}

function ArtikelFunktionsprotokollVorlagenDelete(id) {

    var conf = confirm('Wirklich löschen?');
    if (conf) {
        $.ajax({
            url: 'index.php?module=artikelfunktionsprotokoll_vorlagen&action=delete',
            data: {
                id: id
            },
            method: 'post',
