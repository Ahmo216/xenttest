...
function artselect(el)
{
  ...
  $('#menge').first().focus();
    ...
    <div id="tabs-1">
        ...
        <form method="POST" id="frmstockout" class="form form-horizontal" action="index.php?module=lagermobil&action=stockout">
            ...
            [BEFORESNSCAN]
            <div class="form-group form-group-lg">
                <label for="snscan" class="col-md-1 col-sm-2 control-label">{|SN|}:</label>
                <div class="col-md-5 col-sm-10">
                    <input type="text" name="snscan" id="snscan" class="form-control"/>
                </div>
            </div>
            [AFTERSNSCAN]
            ...
            <div class="form-group form-group-lg">
                <div class="col-sm-offset-2 col-sm-10 col-md-offset-1 col-md-5">
                    <div class="row">
                        <div class="col-xs-6">
                            [BEFORESTEPBEFORE]
                            <input type="button" id="stepbefore" class="btn btn-secondary btn-block btn-lg" value="{|Zurück|}">
                            [AFTERSTEPBEFORE]
                        </div>
                        <div class="col-xs-6">
                            [BEFORENEXTSTEP]
...
<script type="application/javascript">
    $(document).ready(function() {
        $('#frmstockout').on('submit',function(event){
        ...
        $('span.storagelocation').on('click', function () {
            if ($('#step').val() == '2' && $('#locationstorage').length) {
        ...
        $('span.storageamount').on('click', function() {
           if(($('#step').val() == '3' || $('#step').val() == '4') && $('#amount').length) {
        ...
        $('span.storagesn').on('click', function() {
            if(($('#step').val() == '3' || $('#step').val() == '4') && $('#snscan').length) {
                $('#snscan').val($(this).html());
        ...
        $('span.storagebestbefore').on('click', function() {
            if(($('#step').val() == '3') && $('#bestbefore').length) {
                $('#bestbefore').val($(this).html());
                if($('#batch').length) {
                    var $spanbatch = $(this).parents('tr').first().find('span.storagebatch');
                    if($spanbatch.length) {
                        $('#batch').val($($spanbatch).html());
                    }
                }
        ...
        $('span.storagebatch').on('click', function() {
            if(($('#step').val() == '3') && $('#batch').length) {
                $('#batch').val($(this).html());
                if($('#bestbefore').length) {
                    var $spanbestbefore = $(this).parents('tr').first().find('span.storagebestbefore');
                    if($spanbestbefore.length) {
                        $('#bestbefore').val($($spanbestbefore).html());
                    }
                }
        ...
        $('img.deletesn').on('click',function(){
           $(this).parents('tr').first().remove();
        });
