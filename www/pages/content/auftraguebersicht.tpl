...
&nbsp;<select id="sel_aktion" name="sel_aktion">
	...
	[HOOK_SEL_ACTION]
    </select>&nbsp;{|Drucker|}: <select name="seldrucker">[SELDRUCKER]</select>&nbsp;<input type="hidden" name="ausfuehren" value="ausf&uuml;hren" /><button type="submit" class="ui-button" id="ausfuehren">{|ausf&uuml;hren|}</button>
</fieldset>
</form>
</div>
<!--
