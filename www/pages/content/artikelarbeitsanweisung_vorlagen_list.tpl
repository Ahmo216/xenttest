...
$(document).ready(function() {
    ...
    buttons: {
      ...
      SPEICHERN: function() {
        ArtikelArbeitsanweisungVorlagenEditSave();
      }
    }
  });
...
function ArtikelArbeitsanweisungVorlagenEditSave() {

    $.ajax({
        url: 'index.php?module=artikelarbeitsanweisung_vorlagen&action=save',
        data: {
...
function ArtikelArbeitsanweisungVorlagenEdit(id) {

    $.ajax({
        url: 'index.php?module=artikelarbeitsanweisung_vorlagen&action=edit&cmd=get',
        data: {
            id: id
        },
        method: 'post',
...
function updateLiveTable(i) {
    var oTableL = $('#artikelarbeitsanweisung_vorlagen_list').dataTable();
...
function ArtikelArbeitsanweisungVorlagenDelete(id) {

    var conf = confirm('Wirklich löschen?');
    if (conf) {
        $.ajax({
            url: 'index.php?module=artikelarbeitsanweisung_vorlagen&action=delete',
            data: {
                id: id
            },
            method: 'post',
