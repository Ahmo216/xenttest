...
<div id="popupoptionimage" style="display:none;">
	<input type="hidden" id="optionimageid" />
	<fieldset>
		<legend>{|Eigenschaftenbild|}</legend>
		<table>
			<tr>
				<td>{|Aktuelles Bild|}:</td>
				<td id="optionimagefilename"></td>
			</tr>
			<tr>
				<td>{|Titel|}:</td>
				<td><input type="text" id="optionimagetitle" size="50"></td>
			</tr>
			<tr>
				<td>{|Beschreibung|}:</td>
				<td><textarea id="optionimagedescription" cols="50"></textarea></td>
			</tr>
			<tr>
				<td>{|Datei|}:</td>
				<td><input type="file" id="optionimagefile" /></td>
			</tr>
		</table>
	</fieldset>
</div>
