						...
						<div class="inside inside-full-height">
							<fieldset>
								...
								<table>
									...
									<tr>
										<td>
											<label for="turnoverthresholdactive">{|Lieferschwellen updaten|}:</label>
										</td>
										<td>
											<input type="checkbox" name="turnoverthresholdactive" id="turnoverthresholdactive" [TURNOVERTHRESHOLDACTIVE] />
										</td>
									</tr>
									[AFTERTHRESHOLD]
									<tr>
