...
<table width="100%">
<tr><td>{|Deckungsbeitrag (netto) in EUR|}</td><td>{|DB (netto) in %|}</td><td>{|Gebuchte Zeit in Stunden|}</td></tr>
<tr>
  <td class="greybox" width="15%">[DECKUNGSBEITRAG]</td>
  <td class="greybox" width="15%">[DBPROZENT]</td>
  <td class="greybox" width="15%">[GEBUCHTEZEIT]</td>
</tr>
</table>
