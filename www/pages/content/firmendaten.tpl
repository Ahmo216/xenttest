...
<i>Dieser Text erscheint auf dem Angebot, Auftrag und der Rechnung.</i></td></tr>
  ...
  <tr [TR_ZAHLUNG_AMAZON_BESTELLUNG]><td><input type="checkbox" name="zahlung_amazon_bestellung" [ZAHLUNG_AMAZON_BESTELLUNG]></td><td>Amazon Bestellung</td><td></td></tr>
<tr  valign="top" [TR_ZAHLUNG_AMAZON_BESTELLUNG]><td></td><td>Zahlungsbedingungen:</td><td><textarea name="zahlung_amazon_bestellung_de" data-lang="zahlung_amazon_bestellung_de" rows="8" cols="80" style="width:80%">[ZAHLUNG_AMAZON_BESTELLUNG_DE]</textarea><br>
<i>Dieser Text erscheint auf dem Angebot, Auftrag und der Rechnung.</i></td></tr>



  <tr [TR_ZAHLUNG_SECUPAY]><td><input type="checkbox" name="zahlung_secupay" [ZAHLUNG_SECUPAY]></td><td>Secupay</td><td></td></tr>
<tr  valign="top" [TR_ZAHLUNG_SECUPAY]><td></td><td>Zahlungsbedingungen:</td><td><textarea name="zahlung_secupay_de" data-lang="zahlung_secupay_de" rows="8" cols="80" style="width:80%">[ZAHLUNG_SECUPAY_DE]</textarea><br>
<i>Dieser Text erscheint auf dem Angebot, Auftrag und der Rechnung.</i></td></tr>



  <tr [TR_ZAHLUNG_SOFORTUEBERWEISUNG]><td><input type="checkbox" name="zahlung_sofortueberweisung" [ZAHLUNG_SOFORTUEBERWEISUNG]></td><td>Sofort&uuml;berweisung</td><td></td></tr>
<tr  valign="top" [TR_ZAHLUNG_SOFORTUEBERWEISUNG]><td></td><td>Zahlungsbedingungen:</td><td><textarea name="zahlung_sofortueberweisung_de" data-lang="zahlung_sofortueberweisung_de" rows="8" cols="80" style="width:80%">[ZAHLUNG_SOFORTUEBERWEISUNG_DE]</textarea><br>
<i>Dieser Text erscheint auf dem Angebot, Auftrag und der Rechnung.</i></td></tr>



  <tr [TR_ZAHLUNG_RATENZAHLUNG]><td><input type="checkbox" name="zahlung_ratenzahlung" [ZAHLUNG_RATENZAHLUNG]></td><td>Ratenzahlung</td><td></td></tr>
<tr  valign="top" [TR_ZAHLUNG_RATENZAHLUNG]><td></td><td>Zahlungsbedingungen:</td><td><textarea name="zahlung_ratenzahlung_de" data-lang="zahlung_ratenzahlung_de" rows="8" cols="80" style="width:80%">[ZAHLUNG_RATENZAHLUNG_DE]</textarea><br>
<i>Dieser Text erscheint auf dem Angebot, Auftrag und der Rechnung.</i></td></tr>


  <tr [TR_ZAHLUNG_ECKARTE]><td><input type="checkbox" name="zahlung_eckarte" [ZAHLUNG_ECKARTE]></td><td>EC-Karte</td><td></td></tr>
<tr  valign="top" [TR_ZAHLUNG_ECKARTE]><td></td><td>Zahlungsbedingungen:</td><td><textarea name="zahlung_eckarte_de" data-lang="zahlung_eckarte_de" rows="8" cols="80" style="width:80%">[ZAHLUNG_ECKARTE_DE]</textarea><br />
<i>Dieser Text erscheint auf dem Angebot, Auftrag und der Rechnung.</i></td></tr>
			...
			<div class="col-xs-12 col-md-6 col-md-height">
				<div class="inside inside-full-height">
					<fieldset>
						...
						<table cellspacing="5" width="100%">
							<tr><td width="300">Gro&szlig;e Paketannahme:</td><td><input type="checkbox" name="wareneingang_gross" [WARENEINGANG_GROSS]> </td></tr>
	...
	<div class="row">
		<div class="row-height">
			...
			<div class="col-xs-12 col-md-4 col-md-height">
				<div class="inside inside-full-height">
					<fieldset>
						<legend>{|Zusatzfelder Verbindlichkeit|}</legend>
						<table cellspacing="5" width="100%">
							<tr><td width="300">Spalte 1:</td><td><select id="liabilitytablecol1" name="liabilitytablecol1">[LIABILITYTABLECOL1]</select></td></tr>
							<tr><td width="300">Spalte 2:</td><td><select id="liabilitytablecol2" name="liabilitytablecol2">[LIABILITYTABLECOL2]</select></td></tr>
							<tr><td width="300">Spalte 3:</td><td><select id="liabilitytablecol3" name="liabilitytablecol3">[LIABILITYTABLECOL3]</select></td></tr>
							<tr><td width="300">Spalte 4:</td><td><select id="liabilitytablecol4" name="liabilitytablecol4">[LIABILITYTABLECOL4]</select></td></tr>
							<tr><td width="300">Spalte 5:</td><td><select id="liabilitytablecol5" name="liabilitytablecol5">[LIABILITYTABLECOL5]</select></td></tr>
						</table>
					</fieldset>
				</div>
			</div>
				...
				<div class="inside inside-full-height">
					<fieldset>
						...
						<table cellspacing="5" width="100%">
							...
							<tr><td><label for="read_only_kill">{|Report abfragen abbrechen|}</label></td><td></td><td>nach</td><td><input type="text" size="6" name="read_only_kill" id="read_only_kill" value="[READ_ONLY_KILL]" /> Sekunden <i>(Standard 300)</i></td></tr>
						</table>
					</fieldset>
				</div>
			</div>
