...
function lupeclickevent() {
    $('.ui-autocomplete-input').each(function () {
        ...
        if (self.css('display') === 'none'){
            self.next('.autocomplete_lupe').hide();
        }
    });

    $('.autocomplete_lupe').on('click touch', function () {
        var self = $(this),
            found = false;
        ...
        self.prev('.ui-autocomplete-input').each(function () {
            found = true;
            aktlupe = this;
            $(this).val(' ');
            $(this).trigger('keydown');
        ...
        if (!found) {
            self.prev('a').prev('.ui-autocomplete-input').each(function () {
                found = true;
                aktlupe = this;
                $(this).val(' ');
                $(this).trigger('keydown');
