...
class MailAttachmentData implements MailAttachmentInterface
{
    ...
    /**
     * Finds the filename in the Conent-Disposition Header
     *
     * @param string $disposition
     *
     * @return string
     */
    private static function extractFileName(string $disposition): string
    {
        $matches = [];
        preg_match_all('/filename\*?\d*="([^"]+)".*$/m', $disposition, $matches);
