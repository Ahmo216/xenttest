...
use Xentral\Modules\FiskalyApi\Exception\ConfigurationNotFoundException;
...
class FiskalyTransactionFactory
{
    ...
    public function getTransactionRequestFromProjectId(int $projectId): TransactionRequest
    {
        ...
        if(empty($result['client_uuid'])) {
            throw new ConfigurationNotFoundException('no client for project found');
        }
