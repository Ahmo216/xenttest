...
{
    public const TABLE_NAME = 'lieferadressen';
    ...
    public function insert($inputVars, $inputMapping = null)
    {
        ...
        if (!isset($inputVars['abteilung'])) {
            $inputVars['abteilung'] = '';
        }
        if (!isset($inputVars['unterabteilung'])) {
            $inputVars['unterabteilung'] = '';
        }
        if (!isset($inputVars['strasse'])) {
            $inputVars['strasse'] = '';
        }
        if (!isset($inputVars['ort'])) {
            $inputVars['ort'] = '';
        }
        if (!isset($inputVars['plz'])) {
            $inputVars['plz'] = '';
        }
        if (!isset($inputVars['telefon'])) {
            $inputVars['telefon'] = '';
        }
        if (!isset($inputVars['telefax'])) {
            $inputVars['telefax'] = '';
        }
        if (!isset($inputVars['email'])) {
            $inputVars['email'] = '';
        }
        if (!isset($inputVars['steuer'])) {
            $inputVars['steuer'] = '';
        }
        if (!isset($inputVars['sprache'])) {
            $inputVars['sprache'] = '';
        }
        if (!isset($inputVars['sonstiges'])) {
            $inputVars['sonstiges'] = '';
        }
        if (!isset($inputVars['adresszusatz'])) {
            $inputVars['adresszusatz'] = '';
        }
        if (!isset($inputVars['lieferbedingung'])) {
            $inputVars['lieferbedingung'] = '';
        }
