...
final class Bootstrap
{
    ...
    public static function registerServices()
    {
        return [
            ...
            'SystemNotification' => 'onInitSystemNotification',
        ];
    }
     ...
     */
    public static function onInitSystemNotification(ContainerInterface $container): SystemNotification
    {
        return new SystemNotification(
            $container->get('NotificationGateway'),
