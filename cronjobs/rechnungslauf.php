...
$subscriptionCycleFullTask = $app->Container->get(SubscriptionCycleFullTask::class);
try {
...
$subscriptionCycleManualJobTask = $app->Container->get(SubscriptionCycleManualJobTask::class);
try {
