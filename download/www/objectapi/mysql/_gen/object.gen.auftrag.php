...
class ObjGenAuftrag
{
  ...
  private  $shop_status_update_attempt;
  private  $shop_status_update_last_attempt_at;
...
$result = $result[0];
  ...
  public function Update()
  {
    ...
    $sql = "UPDATE `auftrag` SET
      ...
      `shop_status_update_attempt`='{$this->shop_status_update_attempt}',
      `shop_status_update_last_attempt_at`='{$this->shop_status_update_last_attempt_at}'
      WHERE (`id`='{$this->id}')";
  ...
  public function Delete($id='')
  {
    ...
    $this->shop_status_update_attempt='';
    $this->shop_status_update_last_attempt_at='';
  }
 ...
 /** dank dieser funktionen kann man die tatsaechlichen werte einfach 
  ...
  public function SetShop_Status_Update_Attempt($value) { $this->shop_status_update_attempt=$value; }
  public function GetShop_Status_Update_Attempt() { return $this->shop_status_update_attempt; }
  public function SetShop_Status_Update_Last_Attempt_At($value) { $this->shop_status_update_last_attempt_at=$value; }
  public function GetShop_Status_Update_Last_Attempt_At() { return $this->shop_status_update_last_attempt_at; }
