  ...
  <div class="row">
    <div class="row-height">
      <div class="col-xs-12 col-md-12 col-md-height">
        <div class="inside inside-full-height">
          <fieldset>
            <legend>{|Briefpapier Einstellungen|}</legend>
            <table border="0" width="100%">
        ...
        <div class="inside inside-full-height">
          <fieldset>
            ...
            <table border="0" width="100%">
              ...
              <tr><td width="300">{|Gru&szlig;formel|}:</td><td colspan="2">[ABSENDEGRUSSFORMEL][MSGABSENDEGRUSSFORMEL]</td></tr>
              <tr><td width="300">HTML Template:</td><td>[EMAIL_HTML_TEMPLATE][MSGEMAIL_HTML_TEMPLATE]</td></tr>
            </table>
          </fieldset>
        </div>
      </div>
...
<div id="tabs-7">
     ...
     <div class="col-xs-12 col-md-12 col-md-height">
       <div class="inside inside-full-height">
         <fieldset>
           ...
           <table border="0" width="100%">
             <tr><td width="300">Adresse aus Stammdaten</td><td>[FILIALADRESSE][MSGFILIALADRESSE]</td></tr>
             <tr><td width="">Projekt f&uuml;r Lieferung der Zentrale an Fililale</td><td>[VERSANDPROJEKTFILIALE][MSGVERSANDPROJEKTFILIALE]</td></tr>
           </table>
         </fieldset>
       </div>
     </div>
 ...
 <br />
 <input type="submit" name="speichern" value="Speichern" onclick="this.form.action += '#tabs-7';" style="float:right" />
</div>
