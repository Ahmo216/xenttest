...
<!--
<fieldset><legend>{|Art des Produktes|}</legend>
<table width="100%">
<tr><td width="300">{|Art|}:</td>
<td>[STEUER_ART_PRODUKT][MSGSTEUER_ART_PRODUKT]</td>
</tr>
<tr><td width="300">{|Digitaler Inhalt|}:</td><td>[STEUER_ART_PRODUKT_DOWNLOAD][MSGSTEUER_ART_PRODUKT_DOWNLOAD]</td>
</tr>
</table> 
</fieldset>
-->
...
-->
  ...
  [VORSTEUERREGELN]
  <tr>
    <td width="300">{|Steuergruppe|}:</td><td colspan="2">[STEUERGRUPPE][MSGSTEUERGRUPPE]</td>
  </tr>
  [NACHSTEUERREGELN]
  <tr>
    <td width="300">{|Kostenstelle|}:</td><td colspan="2">[KOSTENSTELLE][MSGKOSTENSTELLE]</td>
  </tr>
