                ...
                <td>
                    ...
                    <div id="page_container">
                        ...
                        <div id="progress" style="width:50%;top:100px;left:25%;position:relative;display:block;">
                            ...
                            <div id="wawilink"><a href="./index.php" class="button">Installation vollst&auml;ndig - Zur&uuml;ck
                                    zu xentral</a></div>
                            <div id="upgradediv">
                                <form id="upgradefrm" method="POST" action="index.php?module=welcome&action=upgradedb">
                                    <input type="hidden" name="upgradedb" value="1"/><input type="submit"
                                                                                            style="display:none;"
                                                                                            value=" "
                                    ></form>
                            </div>
    ...
    <div id="footer" class="grid_6">
        <ul>
            ...
            <li>&copy; [YEAR] xentral ERP Software GmbH | xentral &reg; |
                <a href="index.php?module=welcome&action=info">[WAWIVERSION]</a> [LIZENZHINWEIS]
            </li>
        </ul>
    </div>
    <!-- end FOOTER -->
