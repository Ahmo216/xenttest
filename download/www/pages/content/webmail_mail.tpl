...
<table width="100%">
<tr><td><input type="text" name="adresse" id="adresse" value="[ADRESSEVALUE]" size="22"></td></tr>
</table>
[ADRESSEMESSAGE]
...
<input type="button" value="mit Markierung versehen" onclick="window.location.href='index.php?module=webmail&action=warteschlange&id=[ID]'" style="width:170px">
<input type="button" value="DSGVO Markierung" onclick="window.location.href='index.php?module=webmail&action=dsgvo&id=[ID]'" style="width:170px">
</td></tr>
