		...
		<div id="tabs-1">
		  ...
		  <div class="inside inside-full-height">
		    <fieldset>
		      ...
		      <input type="button" class="btnGreenNew" name="neuereintrag" value="&#10010; Neue Ust-ID Pr&uuml;fung" onclick="UstprfEdit(0);">
		    </fieldset>
		  </div>
		  </div>
		  </div>
...
<div id="editUstprf" style="display:none;" title="Bearbeiten">
	  ...
	  <fieldset>
	    ...
	    <table>
	      <tr>
	  		...
	  		<tr>
	  			<td style="vertical-align:bottom">{|einfache Online Prüfung|}:</td>
	  			<td id="onlinestatus" style="vertical-align:bottom"></td>
	  		</tr>
	  		<tr>
	  			<td style="vertical-align:bottom" width="200">{|qualifizierte Online Prüfung|}:</td>
  ...
  <div class="inside inside-full-height">
  	<fieldset>
  		<legend>{|Aktionen|}</legend>
  		<input type="button" class="btnGreenNew" name="online" id="online" value="einfache Online Pr&uuml;fung" onclick="UstprfOnline();">
  		<input type="button" class="btnBlueNew" name="brief" id="brief" value="qualifizierte Online Pr&uuml;fung" onclick="UstprfBrief();">
			<br>
