...
<td width="20%">
<fieldset style="height:125px"><legend>{|Unterseriennummer|}</legend>
<br>
<center>{|Seriennummer scannen|}:&nbsp;<form id="frmproduktionunterseriennummer" action="" method="post"><input type="hidden" id="produktionunterseriennummerid" name="produktionunterseriennummerid" /><input type="text" [UNTERSERIENNUMMERNDEAKTIVIERT] id="produktionunterseriennummer" name="produktionunterseriennummer" size="30"></form></center>
</fieldset>
</td>
...
<td width="20%">
<fieldset style="height:125px"><legend>{|Neue Charge|}</legend>
<br>
<center>{|Chargen-Nr. f&uuml;r Produktion|}:
<input type="text" value="[INFOCHARGE]"size="30" readonly><br></center>
<br><center><input type="button" [CHARGEDEAKTIVIERT] id="chargegenerieren" value="Optional Generator starten" />
</center>
</fielset>
</td>
...
{
  if(!$('#produktionunterseriennummer').hasClass('disabled'))
  {
    $('#produktionunterseriennummer').val('');
    $('#produktionunterseriennummerid').val(id);
    $('#frmproduktionunterseriennummer').submit();
  } else {
