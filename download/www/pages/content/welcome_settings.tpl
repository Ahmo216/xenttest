	...
	<div id="tabs-1">
						...
						<fieldset>
							...
							<div style="width: 100%">
								...
								<div style="display: inline-block; vertical-align: top">
									<button class="button button-primary" [TOTP_DISABLED] id="[TOTP_TOGGLE_ID]" >[TOTP_TOGGLE_VALUE]</button>
									<br>
		...
		<div class="row">
			<div class="row-height">
				...
				<div class="col-xs-12 col-md-6 col-md-height">
					<div class="inside inside-full-height">
						<form id="form-google-calendar" action="index.php?module=welcome&action=settings&cmd=googlecalendar-save" method="post">
							<fieldset>
				...
				<div class="col-xs-12 col-md-6 col-md-height">
					<div class="inside inside-full-height">
						<form id="form-google-mail" action="index.php?module=welcome&action=settings&cmd=gmail-save" method="post">
							<fieldset>
								...
								<table class="mkTableFormular">
									...
									<tr>
										<td></td>
										<td>
											<input type="submit" value="(1) {|Autorisieren|}" id="btn-google-mail-auth" name="submit_authorize_gmail" [GMAIL_AUTH_DISABLE]>
