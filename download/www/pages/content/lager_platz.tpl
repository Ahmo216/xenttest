			...
			<td>
				...
				<fieldset>
					...
					<table border="0" width="100%">
						...
						<tr>
							<td><label for="verbrauchslager">{|Verbrauchslager|}:</label></td>
							<td><input name="verbrauchslager" id="verbrauchslager" type="checkbox" value="1" [VERBRAUCHSLAGER]><i>&nbsp;Es werden nur
									Eingangsbewegungen in das Lager erfasst, aber <b>kein</b> Bestand gef&uuml;hrt.</i></td>
						</tr>
						<tr>
