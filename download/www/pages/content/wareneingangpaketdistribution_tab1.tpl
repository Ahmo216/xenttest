          ...
          <table border="0" width="100%">
            <tr valign="top"><td colspan="2">
              ...
              <fieldset><legend>{|Paket &ouml;ffnen u. Inhalt pr&uuml;fen|}</legend>
                <table width="100%" cellpadding="10" style="background-color:#fff; border: solid 1px #000">
                  <tr><td>{|Lieferschein|}:</td><td><input type="checkbox" name="lieferschein" value="1" [LIEFERSCHEIN]>&nbsp;{|LS-Nr|}:&nbsp;<input type="text" size="20" name="lsnr" value="[LSNR]"></td></tr>
                  <tr><td>{|Rechnung|}:</td><td><input type="checkbox" name="rechnung" value="1" [RECHNUNG]>&nbsp;{|RE-Nr|}:&nbsp;<input type="text" size="20" name="renr" value="[RENR]"></td></tr>
