...
<script language="javascript" type="text/javascript" src="./js/lib/flot/jquery.flot.stack.js"></script>
<script language="javascript" type="text/javascript" src="./js/lib/flot/jquery.flot.pie.min.js"></script>
