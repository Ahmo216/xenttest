	...
	<table width="100%">
		...
		<tr>
            ...
            <tr>
						...
						<tr>
							<td>{|Eigenschaft Name 1|}:</td>
							<td><input type="text" name="eigenschaftname1" id="eigenschaftname1" value=""></td>
						</tr>
						<tr>
							<td>{|Eigenschaft Wert 1|}:</td>
							<td><input type="text" name="eigenschaftwert1" id="eigenschaftwert1" value=""></td>
						</tr>
						<tr>
							<td>{|Eigenschaft Name 2|}:</td>
							<td><input type="text" name="eigenschaftname2" id="eigenschaftname2" value=""></td>
						</tr>
						<tr>
							<td>{|Eigenschaft Wert 2|}:</td>
							<td><input type="text" name="eigenschaftwert2" id="eigenschaftwert2" value=""></td>
						</tr>
						<tr>
							<td>{|Eigenschaft Name 3|}:</td>
							<td><input type="text" name="eigenschaftname3" id="eigenschaftname3" value=""></td>
						</tr>
						<tr>
							<td>{|Eigenschaft Wert 3|}:</td>
							<td><input type="text" name="eigenschaftwert3" id="eigenschaftwert3" value=""></td>
						</tr>
						<tr>
							<td>{|Shopartikel|}:</td>
							<td><input type="text" name="shop" id="shop" value=""></td>
						</tr>
					</table>
				</div>
