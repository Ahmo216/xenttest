...
<tr><td colspan="3"><input type="checkbox" name="showcountrycode" id="showcountrycode" value="1" [SHOWCOUNTRYCODE]>&nbsp;{|KOST1 mit Lieferland füllen anstelle Kostenstelle (Lieferschwelle)|} </td></tr>
