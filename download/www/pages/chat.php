...
class Chat
{
    ...
    public function Install()
    {
        ...
        // chat.js moved to www/js/modules/chat; old file and folder must be deleted
        $this->app->erp->RemoveFile('classes/Modules/Chat/www/js/chat.js');
        $this->app->erp->RemoveFolder('classes/Modules/Chat/www/js');
    }
    ...
    protected function InstallGelesenTable()
    {
        ...
        $this->app->erp->CheckIndex("chat_gelesen", ['user', 'message'], true);
