...
class Shopimporter_Ebay_Adapter
{
   ...
   * @param string $call
   */
  protected function addCallToCount($call): void
  {
    if (isset($this->countCalls[$call])) {
      $this->countCalls[$call]++;
    } else {
      $this->countCalls[$call] = 1;
    }
  }
   ...
   * @param string $call
   */
  public function addAsynchronousCallToCount($call): void
  {
    $this->addCallToCount($call);
  }
