...
<tr><td>Email:</td><td><input type="text" size="36" value="[EMAIL]" name="email"></td></tr>
...
<tr><td>Adresszusatz:</td><td><input type="text" size="36" value="[STRASSE2]" name="strasse2"></td></tr>
<tr><td>Adresszusatz 2:</td><td><input type="text" size="36" value="[STRASSE3]" name="strasse3"></td></tr>
<tr><td>Notiz 1:</td><td><input type="text" size="36" value="[NOTIZ1]" name="notiz1"></td></tr>
<tr><td>Notiz 2:</td><td><input type="text" size="36" value="[NOTIZ2]" name="notiz2"></td></tr>
<tr style="display:[DISPLAYDEPOSIT]"><td>Abgabeort:</td><td><input type="text" size="36" name="deposit_place"></td></tr>
<tr><td>&nbsp;</td></tr>
<tr><td>&nbsp;</td></tr>
<tr id="trgls_auswahl"><td>Alternativer Versender:</td><td><select name="gls_alternativerversender" id="gls_alternativerversender">[GLSALTERNATIVERVERSENDER]</select></td></tr>
...
<br><br>
<table align="center" style="display:[DISPLAYCOD]">
  <tr><td colspan="2"><b>Service</b></td></tr>
  <tr><td>Nachnahme Betrag: [BETRAG]<input type="hidden" name="betrag" value="[BETRAG]"></td></tr>
