...
<tr><td>Strasse/Hausnummer:</td><td><input type="text" size="30" value="[STRASSE]" name="strasse">&nbsp;<input type="text" size="5" name="hausnummer" value="[HAUSNUMMER]"></td></tr>
                ...
                <table style="float:left;">
                        ...
                        [GEWICHT]
                        <tr><td>{|L&auml;nge:|}</td><td><input type="text" size="5" name="laenge" value="[LAENGE]" /> cm</td></tr>
                        <tr><td>{|Breite:|}</td><td><input type="text" size="5" name="breite" value="[BREITE]" /> cm</td></tr>
                        <tr><td>{|H&ouml;he:|}</td><td><input type="text" size="5" name="hoehe" value="[HOEHE]" /> cm</td></tr>
