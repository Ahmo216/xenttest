...
<div id="inlinehelp" [INLINEHELPOPEN]>
	<div class="ui-dialog-titlebar ui-widget-header" id="inlinehelpheading">
		<div class="header-actions">
			...
			<a href="[LINKTOWIKI]" title="[OPEN_IN_NEW_TAB]" target="_blank" class="link-to-wiki">
	...
	<div class="inline-help-content-container">
		...
		<div class="footer-actions">
			<a href="//community.xentral.com" target="_blank" class="button button-secondary">[LINK_TO_COMMUNITY]</a>
			<a href="//community.xentral.com/hc/de/requests/new" target="_blank" class="button button-primary">[CREATE_TICKET_BUTTON]</a>
		</div>
	</div>
</div>
