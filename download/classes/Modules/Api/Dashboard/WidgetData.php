...
class WidgetData
{
    ...
    public const WIDGET_TYPE_SIMPLE = 'simple';

    /** @var string WIDGET_TYPE_SIMPLE_BIG */
    public const WIDGET_TYPE_SIMPLE_BIG = 'simple_big';

    /** @var string WIDGET_TYPE_CONTRAST */
    public const WIDGET_TYPE_CONTRAST = 'contrast';

    /** @var string WIDGET_CONTRAST_BIG */
    public const WIDGET_TYPE_CONTRAST_BIG = 'contrast_big';

    /** @var string WIDGET_TYPE_BARCHART */
    public const WIDGET_TYPE_BARCHART = 'barchart';

    /** @var string WIDGET_TREND_RISE */
    public const WIDGET_TREND_RISE = 'rise';

    /** @var string WIDGET_TREND_FALL */
    public const WIDGET_TREND_FALL = 'fall';

    /** @var string WIDGET_TREND_EQUAL */
    public const WIDGET_TREND_EQUAL = 'equal';

    /** @var string WIDGET_TREND_NONE */
    public const WIDGET_TREND_NONE = 'none';
