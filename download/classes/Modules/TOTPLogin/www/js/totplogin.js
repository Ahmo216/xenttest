var welcomeUi = (function ($) {
        var me = {
            ...
            handleOnClickDisable: function () {
                $.post('index.php?module=totp&action=generate&cmd=disable', {'action': 'disable'}, me.handleDisablePOST);
            },
                ...
                $('#dialog-confirm').dialog({
                    ...
                    buttons: [
                        ...
                        },
                        {
                            ...
                            click: function () {
                                $(this).dialog('close');
                                $.post('index.php?module=totp&action=generate&cmd=enable', {'secret': me.storage.secret},
                                    me.handleEnablePOST);
                            },
