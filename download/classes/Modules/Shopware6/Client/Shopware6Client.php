...
final class Shopware6Client
{
    ...
    /**
     * @param bool $apiVersionGreater640
     */
    public function useApiVersionGreater640(bool $apiVersionGreater640): void
    {
        $this->apiRoute = 'v2/';
        if($apiVersionGreater640){
            $this->apiRoute = '';
        }
    }
    ...
    protected function request(string $method, string $endpoint, array $body = [], array $headerInformation = [])
    {
        ...
        $request = new ClientRequest(
            $method,
            $this->url . $this->apiRoute . $endpoint,
            $headerInformation,
