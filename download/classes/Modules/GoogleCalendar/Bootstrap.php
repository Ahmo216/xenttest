...
final class Bootstrap
{
    ...
    public static function registerServices(): array
    {
        return [
            ...
            'GoogleCalendarSynchronizerTask'  => 'onInitGoogleCalendarSynchronizerTask',
        ];
    }
     ...
     * @param ContainerInterface $container
     *
     * @return GoogleCalendarSynchronizerTask
     */
    public static function onInitGoogleCalendarSynchronizerTask(
        ContainerInterface $container
    ): GoogleCalendarSynchronizerTask
    {
        return new GoogleCalendarSynchronizerTask(
            $container->get('GoogleAccountGateway'),
            $container->get('GoogleCalendarClientFactory'),
            $container->get('GoogleCalendarSynchronizer'),
            $container->get('UserConfigService'),
            $container->get('SystemNotification')
        );
    }
