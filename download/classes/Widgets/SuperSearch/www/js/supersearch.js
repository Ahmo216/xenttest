var SuperSearch = (function ($) {
    ...
    var me = {
        ...
        buildDefaultItemResult: function (item) {
            ...
            if(hasAdditionalInfos && item.additionalInfos.indexOf("legacy_app") > -1) {
                isLegacy = true;
            }

            if(isLegacy) {
                mainTitle = '<span class="title-main faded">' + item.title + '<span class="legacy">LEGACY</span></span>';
            } else {
                mainTitle = '<span class="title-main">' + item.title + '</span>';
            }
