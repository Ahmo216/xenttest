...
final class ConfigLoader
{
    ...
    public static function load()
    {
        ...
        throw new MultiDbConfigNotFoundException(
            sprintf(
                'MultiDb-Config "%s" not found.',
                $dbSelect
            )
        );
    }
    ...
    private static function buildConfigFromMultiDbArray($defaultConfig, $multiDbItem)
    {
        ...
        $config->WFdbreadonlyuser = isset($multiDbItem['dbreadonlyuser']) ? $multiDbItem['dbreadonlyuser'] : $multiDbItem['dbuser'];
        $config->WFdbreadonlypass = isset($multiDbItem['dbreadonlypass']) ? $multiDbItem['dbreadonlypass'] : $multiDbItem['dbpass'];
