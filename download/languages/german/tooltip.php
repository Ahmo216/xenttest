...
/* Adresse - Ust-ID Prf. */
$tooltip['adresse']['ustprf']['#online']="Bei einer einfachen Online Pr&uuml;fung wird gepr&uuml;ft, ob die angegebene Ust-ID g&uuml;ltig ist.";
$tooltip['adresse']['ustprf']['#brief']="Bei einer qualifizierten Online Pr&uuml;fung wird zus&auml;tzlich gepr&uuml;ft, ob auch Firmenname, Stra&szlig;e, Ort und PLZ g&uuml;ltig sind.";
...
$tooltip['artikel']['create']['#ausverkauft']="Artikel sind im Shop als nicht mehr verfügbar markiert.<br><br>Bei einer Änderung dieser Option, muss der Artikel manuell exportiert werden, damit die Änderung an den Shop übertragen wird.";
$tooltip['artikel']['edit']['#ausverkauft']="Artikel sind im Shop als nicht mehr verfügbar markiert.<br><br>Bei einer Änderung dieser Option, muss der Artikel manuell exportiert werden, damit die Änderung an den Shop übertragen wird.";
$tooltip['artikel']['create']['#inaktiv']="Artikel sind im Shop nicht mehr sichtbar (inaktiv).<br><br>Bei einer Änderung dieser Option, muss der Artikel manuell exportiert werden, damit die Änderung an den Shop übertragen wird.";
$tooltip['artikel']['edit']['#inaktiv']="Artikel sind im Shop nicht mehr sichtbar (inaktiv).<br><br>Bei einer Änderung dieser Option, muss der Artikel manuell exportiert werden, damit die Änderung an den Shop übertragen wird.";
...
$tooltip['konten']['edit']['#saldo_summieren']="Wenn aktiv, wird der Saldo Betrag mit den Beträgen aus den Kontoauszügen aufsummiert. Wenn nicht, wird nur der Saldo Betrag angezeigt. Zu sehen im Modul 'Zahlungseingang'";
...
/* Anträge einreichen */
$tooltip['mitarbeiterzeiterfassung']['timemanagementrequest']['responsible-group'] = 'Wählen Sie die Gruppe aus, in der auch Ihr Vorgesetzter Mitglied ist, damit der Antrag freigegeben werden kann. Sollte es keine Gruppe zur Auswahl geben, sind Sie kein Mitglied einer Gruppe, oder kein Vorgesetzter ist in Ihrer Gruppe vorhanden.';
...
$tooltip['lieferschwelle']['list']['e_ueberschreitung'] = 'Wird automatisch gesetzt, sobald Lieferschwelle in EUR überschritten wurde. Kann im Ausnahmefall manuell eingefügt werden, wenn “Lieferschwelle aktiv” ebenfalls händisch aktiviert wurde.';
$tooltip['lieferschwelle']['list']['e_umsatz'] = 'Wird mit jedem B2C-Auftrag in das eingestellte Empfängerland automatisch hochgezählt. Sobald der aktuelle Umsatz die Lieferschwelle in EUR überschreitet, wird die Lieferschwelle automatisch aktiv gesetzt und die Besteuerung des Empfängerlandes angewendet. Die Option “Bei Überschreitung neue Steuer verwenden:” in den Einstellungen muss hierfür aktiviert sein.<br />
Sobald der Umsatz ins EU-Ausland die EU-weite Schwelle überschreitet, werden alle EU-Lieferschwellen aktiv gesetzt und angewendet.';
...
$tooltip['carrierselect']['list']['#carrier-select-popup-carrier'] = 'Diese Versandart wird für den Auftrag automatisch bei Shopimport
 einmalig gesetzt wenn die Regeln zutreffen. Bei manueller Auftragsanlage wird ein Hinweis nach Freigabe angezeigt.
Sobald diese ermittelt wird kann man diese nur noch manuell anpassen.';
$tooltip['carrierselect']['list']['#carrier-select-popup-priority'] =  'Sollten mehrere Regeln gleichzeitig
greifen kann mit dem Priofeld gesteuert werden welche Regel bevorzugt werden soll. 
Um so kleiner der Wert der Prio um so mehr wird die Regel den anderen bevorzugt.';
