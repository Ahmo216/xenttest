...
class ApplicationCore
{
  ...
  public function __construct($config = null,$group='')
  {
    ...
    /** @var ContainerInterface $container */
    $container = \App\Core\Application::getInstance();
    $container->instance('LegacyApplication', $this);
  ...
  public function __get($value)
  {
    if(isset($this->getter[$value]))
    {
      ...
      if(!empty($this->getter[$value]['app'])){
    ...
    if($value === 'readonlyDB') {
      if(property_exists($this->Conf, 'WFdbreadonlyuser') && property_exists($this->Conf, 'WFdbreadonlypass')) {
        $this->readonlyDB = new DB($this->Conf->WFdbhost,$this->Conf->WFdbname,$this->Conf->WFdbreadonlyuser,$this->Conf->WFdbreadonlypass,$this,$this->Conf->WFdbport);
        return $this->readonlyDB;
      }

      $this->readonlyDB = new DB($this->Conf->WFdbhost,$this->Conf->WFdbname,$this->Conf->WFdbuser,$this->Conf->WFdbpass,$this,$this->Conf->WFdbport);
      return $this->readonlyDB;
    }
  }
